...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Jayant Sharma 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/whatsapp-pic.jpeg" alt="Jayant" />
              </div>
              <div className="player-details">
                <span className="player-name">Jayant</span>
